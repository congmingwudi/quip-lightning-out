...
import './lib/lightningOut.css';
import { lightingOutApp } from './lib/lightningOutApp.js';
...
class LightningOut extends React.Component {
    constructor(props) {
        super();
    } 
